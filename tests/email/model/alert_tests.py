...
def test_computer_monitor_alerts():
    """
    ...
    msg = MailRequest('fakepeer', "me@localhost", addr, open(home("tests/data/emails/computer-alerts.msg")).read())
    blurbs = alerts.create_blurbs(msg, alert)
    assert True
